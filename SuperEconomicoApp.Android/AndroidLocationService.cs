...
namespace SuperEconomicoApp.Droid
{
    ...
    public class AndroidLocationService : Service
    {
		...
		public override StartCommandResult OnStartCommand(Intent intent, StartCommandFlags flags, int startId)
		{
			...
			// CON ESTO ENVIAMOS LA NOTIFICACION
			Notification notification = new NotificationHelper().GetServiceStartedNotification();
			StartForeground(SERVICE_RUNNING_NOTIFICATION_ID, notification); // AQUI INICIAMOS EL SERVICIO EN SEGUNDO PLANO
			...
			Task.Run(() => {
				...
				{
					// SIEMPRE VERIFICAMOS SI SE CANCELO EL SERVICIO Y NOTIFICAMOS PARA DETENERLO
